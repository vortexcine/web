...
const Portfolio = () => {
  ...
  const projects: Project[] = [
    ...
    { id: 11, title: cleanFileName('Paisajismo 2.JPG'), category: 'Fotografía', image: `${import.meta.env.BASE_URL}images/portfolio/fotografia/Paisajismo 2.JPG`, type: 'fotografia' },
    { id: 12, title: cleanFileName('Registro DJ La Feria 2.jpg'), category: 'Fotografía', image: `${import.meta.env.BASE_URL}images/portfolio/fotografia/Registro DJ La Feria 2.jpg`, type: 'fotografia' },
    { id: 13, title: cleanFileName('Registro Festival 5.jpg'), category: 'Fotografía', image: `${import.meta.env.BASE_URL}images/portfolio/fotografia/Registro Festival 5.jpg`, type: 'fotografia' },
    { id: 14, title: cleanFileName('Registro Paxlito en Vivo 1.jpg'), category: 'Fotografía', image: `${import.meta.env.BASE_URL}images/portfolio/fotografia/Registro Paxlito en Vivo 1.jpg`, type: 'fotografia' },
    { id: 15, title: cleanFileName('Sesión de Fotos 3.JPG'), category: 'Fotografía', image: `${import.meta.env.BASE_URL}images/portfolio/fotografia/Sesión de Fotos 3.JPG`, type: 'fotografia' },
    { id: 16, title: cleanFileName('Sesión de Fotos 6.jpg'), category: 'Fotografía', image: `${import.meta.env.BASE_URL}images/portfolio/fotografia/Sesión de Fotos 6.jpg`, type: 'fotografia' },
    // Make Off (8 imágenes)
    { id: 17, title: cleanFileName('Detrás de cámara _Verte Encima_(1).jpg'), category: 'Make Off', image: `${import.meta.env.BASE_URL}images/portfolio/makeoff/Detrás de cámara _Verte Encima_(1).jpg`, type: 'makeoff' },
    { id: 18, title: cleanFileName('Detrás de cámara _Verte Encima_.jpg'), category: 'Make Off', image: `${import.meta.env.BASE_URL}images/portfolio/makeoff/Detrás de cámara _Verte Encima_.jpg`, type: 'makeoff' },
    { id: 19, title: cleanFileName('Detrás de cámara _Verte Encima 4_.jpg'), category: 'Make Off', image: `${import.meta.env.BASE_URL}images/portfolio/makeoff/Detrás de cámara _Verte Encima 4_.jpg`, type: 'makeoff' },
    { id: 20, title: cleanFileName('Equipo de Arte.jpg'), category: 'Make Off', image: `${import.meta.env.BASE_URL}images/portfolio/makeoff/Equipo de Arte.jpg`, type: 'makeoff' },
    { id: 21, title: cleanFileName('Equipo iluminacion.jpg'), category: 'Make Off', image: `${import.meta.env.BASE_URL}images/portfolio/makeoff/Equipo iluminacion.jpg`, type: 'makeoff' },
    { id: 22, title: cleanFileName('Operador de Camara _Voy y Vuelvo_(1).jpg'), category: 'Make Off', image: `${import.meta.env.BASE_URL}images/portfolio/makeoff/Operador de Camara _Voy y Vuelvo_(1).jpg`, type: 'makeoff' },
    { id: 23, title: cleanFileName('Operador de camara _Voy y Vuelvo_.jpg'), category: 'Make Off', image: `${import.meta.env.BASE_URL}images/portfolio/makeoff/Operador de camara _Voy y Vuelvo_.jpg`, type: 'makeoff' },
    { id: 24, title: cleanFileName('Prueba de Iluminacion(1).jpg'), category: 'Make Off', image: `${import.meta.env.BASE_URL}images/portfolio/makeoff/Prueba de Iluminacion(1).jpg`, type: 'makeoff' },
  ];
