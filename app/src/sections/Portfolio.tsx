...
const Portfolio = () => {
  ...
  const projects: Project[] = [
    ...
    { id: 9, title: cleanFileName('Sesión de Fotos 14.webp'), category: 'Fotografía', image: '/images/portfolio/fotografia/Sesión de Fotos 14.webp', type: 'fotografia', objectPosition: 'center 42%' },
    ...
    { id: 13, title: cleanFileName('Registro Festival 5.webp'), category: 'Fotografía', image: '/images/portfolio/fotografia/Registro Festival 5.webp', type: 'fotografia', objectPosition: '75% center' },
    { id: 14, title: cleanFileName('Registro Paxlito en Vivo 1.webp'), category: 'Fotografía', image: '/images/portfolio/fotografia/Registro Paxlito en Vivo 1.webp', type: 'fotografia', objectPosition: 'center 45%' },
    ...
    // Make Off (8 imágenes)
    { id: 17, title: cleanFileName('Detrás de cámara _Verte Encima_(1).webp'), category: 'Make Off', image: '/images/portfolio/makeoff/Detrás de cámara _Verte Encima_(1).webp', type: 'makeoff', objectPosition: 'center 75%' },
    { id: 18, title: cleanFileName('Detrás de cámara _Verte Encima_.webp'), category: 'Make Off', image: '/images/portfolio/makeoff/Detrás de cámara _Verte Encima_.webp', type: 'makeoff', objectPosition: '30% center' },
            ...
            <button
              ...
              className={`px-5 py-2 rounded-full text-sm font-medium transition-all ${
                activeFilter === filter.id
                  ? 'bg-gradient-to-r from-[#CC33CC] to-[#8F248F] text-white'
              ...
              <>
                <div className="relative h-full bg-black/90">
                      ...
                      <>
                        ...
                        {canPlaySelectedVideo ? (
                          <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
                            <div className="w-16 h-16 rounded-full bg-[#CC33CC]/85 border border-white/20 flex items-center justify-center shadow-[0_0_30px_rgba(204,51,204,0.45)]">
                  ...
                  <div className="absolute left-5 right-5 bottom-4 md:left-8 md:right-8">
                    ...
                    <DialogDescription className="text-[#E085E0] mt-1 text-sm font-medium uppercase tracking-wide drop-shadow-[0_2px_10px_rgba(0,0,0,0.55)]">
