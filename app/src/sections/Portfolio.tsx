            ...
            <button
              ...
              className={`px-5 py-2 rounded-full text-sm font-medium transition-all ${
                activeFilter === filter.id
                  ? 'bg-gradient-to-r from-[#D946EF] to-[#A21CAF] text-white'
              ...
              {filteredProjects.map((project, index) => (
                ...
                >
                  ...
                  {project.type === 'videoclip' && videoclipFirstIds.has(project.id) && Boolean(videoclipLinks[project.id]) && (
                    <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-12 h-12 rounded-full bg-[#D946EF]/80 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-all duration-300 group-hover:scale-110">
              ...
              <>
                <div className="relative h-full bg-black/90">
                  ...
                  <div className="absolute left-5 right-5 bottom-4 md:left-8 md:right-8">
                    ...
                    <DialogDescription className="text-[#E879F9] mt-1 text-sm font-medium uppercase tracking-wide drop-shadow-[0_2px_10px_rgba(0,0,0,0.55)]">
