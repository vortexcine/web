          ...
          <div className="lg:col-span-2 space-y-8">
            <div className="reveal stagger-1 space-y-6">
              {contactInfo.map((item) => (
                ...
                >
                  <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-[#CC33CC]/20 to-[#E085E0]/20 flex items-center justify-center flex-shrink-0 group-hover:from-[#CC33CC]/30 group-hover:to-[#E085E0]/30 transition-all">
                    <item.icon className="text-[#CC33CC]" size={20} />
                  </div>
                  <div>
                    <p className="text-gray-500 text-sm mb-1">{item.label}</p>
                    <p className="text-white font-medium group-hover:text-[#CC33CC] transition-colors">
                      {item.value}
                    </p>
                  </div>
                </a>
              ...
              <div className="flex gap-3">
                {socialLinks.map((social) => (
                  <a
                    ...
                    className="w-11 h-11 rounded-xl bg-white/5 hover:bg-[#CC33CC] border border-white/10 hover:border-[#CC33CC] flex items-center justify-center transition-all"
                ...
                <>
                  <div className="grid sm:grid-cols-2 gap-5 mb-5">
                    <div>
                      ...
                      <input
                        ...
                        required
                        className="w-full bg-black/30 border border-white/10 rounded-lg px-4 py-3 text-white placeholder-gray-500 focus:outline-none focus:border-[#CC33CC] focus:ring-1 focus:ring-[#CC33CC] transition-all"
                  ...
                  <div className="mb-5">
                    ...
                    <select
                      ...
                      onChange={handleChange}
                      required
                      className="w-full bg-black/30 border border-white/10 rounded-lg px-4 py-3 text-white focus:outline-none focus:border-[#CC33CC] focus:ring-1 focus:ring-[#CC33CC] transition-all appearance-none cursor-pointer"
                    >
                  ...
                  <div className="mb-6">
                    ...
                    <textarea
                      ...
                      required
                      rows={5}
                      className="w-full bg-black/30 border border-white/10 rounded-lg px-4 py-3 text-white placeholder-gray-500 focus:outline-none focus:border-[#CC33CC] focus:ring-1 focus:ring-[#CC33CC] transition-all resize-none"
